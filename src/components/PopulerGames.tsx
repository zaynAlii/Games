...
export const PopulerGames = ({gamebyGenre,printName}:{gamebyGenre:any,printName:string}) => {
  ...
  return (
    ...
    <div className='md:flex overflow-hidden '>
        ...
        {
            return <div className={`text-white  flex-shrink-0  cursor-pointer -translate-x-[${Tval}] sm:w-full  md:w-[300px] border-l-4 border-b-2 rounded-xl border-green-800 m-2 p-3 group hover:scale-110 transition-all ease-in-out duration-300 `}>
